...
//             type="text" className='bg-transparent border-none outline-none text-white text-xs placeholder-[#c8c8c8c] flex-1' placeholder="search user"/>
//           </div>
//       </div>
...
//            ${user?._id===user._id && 'bg-[#282142]/50'}
//           `}>
